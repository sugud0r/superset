...
export const TIME_FILTER_LABELS = {
  time_range: t('Rango de tiempo'),
  granularity_sqla: t('Columna de tiempo'),
  time_grain_sqla: t('Granularidad de tiempo'),
  druid_time_origin: t('Origen'),
  granularity: t('Granularidad'),
};
